...
pro irisARLwAvgWthSP
  ...
  for i = nStNum, nEdNum do begin   
      ...
      restore, sAvgSpFitSavDir + '*.sav', /ve
      
      ; Calcuate some useful physical quantities
      irisARLwAvgWth, sAvgSpWthSavDir, sAvgSpWthImgDir, uAvgFitRes, nXCen, nYCen, oIrisObj, nWaveWin, aVelXs, aAvgSp
