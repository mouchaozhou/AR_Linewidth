...
pro irisARLwAvgWthBG
  ...
  for i = nStNum, nEdNum do begin   
      ...
      restore, sAvgBgFitSavDir + '*.sav', /ve
      
      ; Calcuate some useful physical quantities
      irisARLwAvgWth, sAvgBgWthSavDir, sAvgBgWthImgDir, uAvgFitRes, nXCen, nYCen, oIrisObj, nWaveWin, aVelXs, aAvgSp
