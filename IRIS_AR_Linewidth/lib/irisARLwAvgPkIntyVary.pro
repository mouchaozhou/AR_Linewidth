pro irisARLwAvgPkIntyVary, nStCaseNum, nEdCaseNum, sAvgWthSavPartDirName, sAvgFitTauSavDir, $
  ...
  for i = nStCaseNum, nEdCaseNum do begin
      ...
      aAvgPkInty = dblarr(nNCase) -2D      ; The total intensity of each AR
      ...
      aValidIndex  = where((aAvgPkInty ge uImgPars.aYThresh[0]) and (aAvgPkInty le uImgPars.aYThresh[1]))
  ...
  plot, aMus, aAvgPkIntys, /xstyle, /ystyle, psym=nPsym, xrange=aDfXrange, xtitle='!7l!X', ytitle='I(!7l!X)/I(1)', $
